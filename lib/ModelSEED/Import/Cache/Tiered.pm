...
has 'local' =>
    (is => 'rw', isa => 'HashRef', lazy => 1, builder => '_buildLocal');
has 'shared' => (
    is      => 'rw',
    isa     => 'BerkeleyDB::Hash',
    lazy    => 1,
    builder => '_buildShared'
);
has 'shared_env' => (
    is      => 'rw',
    isa     => 'BerkeleyDB::Env',
    lazy    => 1,
    builder => '_buildSharedEnv'
);
has 'debug_stats' =>
    (is => 'rw', isa => 'HashRef', builder => '_buildStats', lazy => 1);
