########################################################################
# ModelSEED::MS::DB::ReactionInstanceAlias - This is the moose object corresponding to the ReactionInstanceAlias object
# Authors: Christopher Henry, Scott Devoid, Paul Frybarger
# Contact email: chenry@mcs.anl.gov
# Development location: Mathematics and Computer Science Division, Argonne National Lab
########################################################################
package ModelSEED::MS::DB::ReactionInstanceAlias;
...
# PARENT:
has parent => (is => 'rw', isa => 'ModelSEED::MS::ReactionInstanceAliasSet', weak_ref => 1, type => 'parent', metaclass => 'Typed');
...
# CONSTANTS:
sub _type { return 'ReactionInstanceAlias'; }
...
my $attribute_map = {reactioninstance_uuid => 0, alias => 1};
sub _attributes {
    my ($self, $key) = @_;
    if (defined($key)) {
