...
use ModelSEED::MS::LazyHolder::RoleSetAlias;
...
# SUBOBJECTS:
has roleSetAliases => (is => 'bare', coerce => 1, handles => { roleSetAliases => 'value' }, default => sub{return []}, isa => 'ModelSEED::MS::RoleSetAlias::Lazy', type => 'child(RoleSetAlias)', metaclass => 'Typed');
