...
$objectDefinitions->{Biochemistry} = {
	...
	class => 'parent',
	attributes => [
		{name => 'uuid',perm => 'rw',type => 'Str',len => 36,req => 0},
		{name => 'modDate',perm => 'rw',type => 'Str',req => 0},
		{name => 'locked',perm => 'rw',type => 'Int',req => 0,default => "1"},
		{name => 'public',perm => 'rw',type => 'Int',req => 0,default => "0"},
		{name => 'name',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
	],
	subobjects => [
...
$objectDefinitions->{Compound} = {
	...
	attributes => [
		...
		{name => 'name',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'abbreviation',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'cksum',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'unchargedFormula',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'formula',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
...
$objectDefinitions->{InstanceTransports} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'reactioninstance_uuid',perm => 'rw',type => 'Str',len => 36,req => 1},
		{name => 'compound_uuid',perm => 'rw',type => 'Str',len => 36,req => 1},
		{name => 'compartment_uuid',perm => 'rw',type => 'Str',len => 36,req => 1},
...
$objectDefinitions->{Compoundset} = {
	...
	attributes => [
		...
		{name => 'id',perm => 'rw',type => 'Str',len => 32,req => 1},
		{name => 'name',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'searchname',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'class',perm => 'rw',type => 'Str',len => 255,req => 0,default => "unclassified"},
		{name => 'type',perm => 'rw',type => 'Str',len => 32,req => 1},
	],
	subobjects => [
...
$objectDefinitions->{Model} = {
	...
	attributes => [
		...
		{name => 'locked',perm => 'rw',type => 'Int',req => 0,default => "0"},
		{name => 'public',perm => 'rw',type => 'Int',req => 0,default => "0"},
		{name => 'id',perm => 'rw',type => 'Str',len => 255,req => 1},
...
$objectDefinitions->{ModelCompartment} = {
	...
	attributes => [
		...
		{name => 'compartment_uuid',perm => 'rw',type => 'Str',len => 36,req => 1},
		{name => 'compartmentIndex',perm => 'rw',type => 'Int',req => 1},
		{name => 'label',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
...
$objectDefinitions->{Modelfba} = {
	...
	attributes => [
		...
		{name => 'modDate',perm => 'rw',type => 'Str',req => 0},
		{name => 'locked',perm => 'rw',type => 'Int',req => 0,default => "0"},
		{name => 'name',perm => 'rw',type => 'Str',len => 255,req => 1,default => ""},
		...
		{name => 'geneko',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'reactionko',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'drainRxn',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'growthConstraint',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'uptakeLimits',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'thermodynamicConstraints',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
...
$objectDefinitions->{Genome} = {
	...
	attributes => [
		...
		{name => 'id',perm => 'rw',type => 'Str',len => 32,req => 1},
		{name => 'name',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'source',perm => 'rw',type => 'Str',len => 255,req => 1},
		{name => 'type',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'taxonomy',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'cksum',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
...
$objectDefinitions->{Roleset} = {
	...
	attributes => [
		...
		{name => 'searchname',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""},
		{name => 'class',perm => 'rw',type => 'Str',len => 255,req => 0,default => "unclassified"},
		{name => 'subclass',perm => 'rw',type => 'Str',len => 255,req => 0,default => "unclassified"},
		{name => 'type',perm => 'rw',type => 'Str',len => 32,req => 1}
	],
	subobjects => [
...
$objectDefinitions->{ReactionRule} = {
	...
	attributes => [
		...
		{name => 'compartment_uuid',perm => 'rw',type => 'Str',len => 36,req => 1},
		{name => 'direction',perm => 'rw',type => 'Str',len => 1,req => 0,default => "="},
		{name => 'transprotonNature',perm => 'rw',type => 'Str',len => 255,req => 0,default => ""}
	],
	subobjects => [
