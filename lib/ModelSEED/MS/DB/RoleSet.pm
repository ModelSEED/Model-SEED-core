...
# SUBOBJECTS:
has rolesroles => (is => 'rw', isa => 'ArrayRef[HashRef]', default => sub { return []; }, type => 'encompassed(RoleSetRole)', metaclass => 'Typed', reader => '_rolesroles');
...
# SUBOBJECT READERS:
around 'rolesroles' => sub {
    my ($orig, $self) = @_;
    return $self->_build_all_objects('rolesroles');
};
