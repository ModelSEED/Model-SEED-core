...
has binary => ( is => 'rw', isa => 'Bool', type => 'attribute', metaclass => 'Typed', default => '0' );
has start => ( is => 'rw', isa => 'Num', type => 'attribute', metaclass => 'Typed', required => 1, default => '0' );
...
has value => ( is => 'rw', isa => 'Num', type => 'attribute', metaclass => 'Typed', required => 1, default => '0' );
...
has primal => ( is => 'rw', isa => 'Bool', type => 'attribute', metaclass => 'Typed', required => 1, default => '1' );
