########################################################################
# exchangeformat_to_fbamodel.pl - This is a KBase command script automatically built from server specifications
...
my $usage = "exchangeformat_to_fbamodel [--input exchange-file] [--output model-file] [--url service-url] [< exchange-file] [> model-file]";
...
my $output = $fbaModelServicesObj->exchangeformat_to_fbamodel($input);
