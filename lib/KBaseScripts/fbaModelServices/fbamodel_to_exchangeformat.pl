########################################################################
# fbamodel_to_exchangeformat.pl - This is a KBase command script automatically built from server specifications
...
my $usage = "fbamodel_to_exchangeformat [--input model-file] [--output exchange-file] [--url service-url] [< model-file] [> exchange-file]";
