########################################################################
# get_gapfilling_formulation.pl - This is a KBase command script automatically built from server specifications
...
my $usage = "get_gapfilling_formulation [--input formulation-id] [--output formulation-file] [--url service-url] [< formulation-id] [> formulation-file]";
...
my $output = $fbaModelServicesObj->get_gapfilling_formulation($input);
