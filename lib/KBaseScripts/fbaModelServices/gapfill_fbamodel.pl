########################################################################
# gapfill_fbamodel.pl - This is a KBase command script automatically built from server specifications
...
my $usage = "gapfill_fbamodel [--input model-file] [--output model-file] [--form formulation] [--url service-url] [< model-file] [> model-file]";
...
my $output = $fbaModelServicesObj->gapfill_fbamodel($input,$formulation);
