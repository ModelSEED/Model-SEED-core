########################################################################
# create_gapfilling_formulation.pl - This is a KBase command script automatically built from server specifications
...
my $usage = "create_gapfilling_formulation [--input exchange-file] [--output formulation-file] [--url service-url] [< exchange-file] [> formulation-file]";
...
my $output = $fbaModelServicesObj->create_gapfilling_formulation($input);
